...
def main():
    ...
    objectives = get_input("enter your objective:")

    educations = get_input("enter your education details(separated by commas):").split(',')
    ...
    certificates = get_input("Enter your certificates references (separated by commas): ").split(',')
    job_history = []
